...
- **Block Timestamps plugin** (`third-party-block-timestamps`, community, disabled by default): Right-click "Show Block Info" opens a popup showing the block's creation time, last-update time, and ID
