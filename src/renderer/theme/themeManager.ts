...
export const UI_FONT_OPTIONS: ReadonlyArray<{ label: string; value: string }> = [
  ...
  {
    label: "LXGW Bright",
    value: "'LXGW Bright', 'Microsoft YaHei', 'PingFang SC', 'Hiragino Sans GB', Arial, sans-serif",
  },
  {
    label: "System UI",
    value: '-apple-system, BlinkMacSystemFont, "Segoe UI", "Microsoft YaHei", "PingFang SC", "Hiragino Sans GB", sans-serif',
  },
  {
    label: "Nunito",
    value: '"Nunito", "Microsoft YaHei", "PingFang SC", "Hiragino Sans GB", sans-serif',
  },
];
...
export const THEMES: Record<string, ThemeDefinition> = {
  ...
  organic: {
    ...
    variables: {
      ...
      "--font-mono": '"SF Mono", "Fira Code", monospace',
      "--font-sans": '"Nunito", -apple-system, BlinkMacSystemFont, "Segoe UI", "Microsoft YaHei", "PingFang SC", "Hiragino Sans GB", sans-serif',
      "--font-size": "15px",
    },
  },
